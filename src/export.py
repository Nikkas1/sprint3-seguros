...
def export_to_csv(data: list[dict], filename_prefix: str, user_id: str):
    ...
    if not data:
        ...
        logger.warning(f"Tentativa de exportar CSV vazia: {filename_prefix} por {user_id}")
        return None
    ...
    try:
        ...
        logger.info(f"Relatório '{filename_prefix}' exportado com sucesso para '{filepath}' por {user_id}.")
        return filepath
